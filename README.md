...
<div align="center">
  <h1>Hi there 👋, I'm Mujahidul Islam</h1>
  <h3>Computer Engineer | Web Developer | IT Support | Designer</h3>
  <p>Passionate about crafting dynamic web solutions and contributing to innovative environments.</p>
</div>

<h3>🚀 About Me</h3>
<p>
I'm a Computer Engineer with a strong foundation in MERN Stack web development, IT Support Systems, and Graphics Design. I'm proficient in creating dynamic and scalable web solutions, troubleshooting technical issues, and delivering creative visual content. My drive is to excel in fast-paced and innovative environments while contributing to organizational success.
</p>

<ul>
  <li>🔭 I'm currently working on Fiverr.com and gaining real-life internship experience.</li>
  <li>🌱 I'm continuously learning Computer Science and Technology, Data Science, and Algorithms to expand my expertise.</li>
  <li>👯 I'm looking to collaborate on Blogs, IT Farms, and CMT projects.</li>
  <li>🤔 I'm actively seeking opportunities to join an IT Job where I can apply my skills and grow.</li>
  <li>💬 Feel free to ask me about programming languages and IT-related topics.</li>
  <li>📫 How to reach me: You can connect with me via the links below!</li>
</ul>
...
<h4 align="center">Other Programming Languages</h4>
<p align="center">
...
<h3>💼 Experience</h3>
<ul>
  <li><strong>Executive-IT</strong> | DADA(DHAKA) LTD, Tongi, Gazipur — <em>August 2024 - February 2025</em></li>
  <li><strong>Web Developer</strong> | Gazipur Software Development Center — <em>February 2023 - January 2024</em></li>
  <li><strong>IT Support Executive</strong> | CADD Zone — <em>March 2022 - February 2023</em></li>
  <li><strong>Course Co-Ordinator</strong> | CADD Zone — <em>May 2021 - January 2022</em></li>
</ul>

<h3>🎓 Education</h3>
<ul>
  <li>Diploma in Engineering, Computer Engineering | BGIFT Institute of Science and Technology (BIST) — <strong>CGPA: 3.99/4.00</strong></li>
  <li>SSC, Science | Kurua High School — <strong>GPA: 4.17</strong></li>
  <li>JSC | Kurua High School — <strong>GPA: 4.29</strong></li>
</ul>

<h3>🏅 Certifications</h3>
<ul>
  <li>Full Stack Web Development with MERN | Ostad — March 2023</li>
  <li>Cross Platform Flutter App Dev | Skill Project — April 2022</li>
  <li>Graphics Design | BIST - NTVQF — 2022</li>
  <li>MTCNA</li>
  <li>CCNA</li>
</ul>
